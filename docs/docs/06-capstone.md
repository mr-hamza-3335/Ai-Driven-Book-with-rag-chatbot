...
| Response time | Less than 500ms for commands | ROS 2 real-time |
...
| Navigation accuracy | Less than 10cm | RMS error to goal |
| Pick success | >85% | Grasp completion |
| Response latency | Less than 500ms | Command to motion |
